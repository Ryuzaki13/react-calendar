/**
 * Публичные типы календаря. Адаптированы из @types/react-big-calendar@1.16.3
 * (DefinitelyTyped, лицензия MIT) для публикации вместе с этим форком.
 */
import {
    add,
    endOf,
...
/** Компоненты-обёртки, которые библиотека действительно экспортирует как значение. */
